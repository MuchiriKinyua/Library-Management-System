...
--
-- Host: localhost
-- Generation Time: Feb 20, 2025 at 02:07 PM
...
CREATE TABLE `resources` (
  ...
  `file_url` varchar(20) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `types` (
  `id` int(11) NOT NULL,
  `full_name` varchar(100) DEFAULT NULL,
  `borrow_limit` varchar(100) DEFAULT NULL,
  `duration_in_days` varchar(20) DEFAULT NULL,
...
(1, 'Muchiri Kinyua', 'muchiri.kinyua@gmail.com', NULL, '$2y$12$4rubiJ/zMEylnTeoHEGAru9XjuYcoFvqfuYAA7M79HU4XBAZ8pAeO', NULL, '2025-02-20 06:50:51', '2025-02-20 06:50:51', 'user'),
(2, 'admin', 'admin@gmail.com', NULL, '$2y$12$Hz17MBQ/jBBAWAKZ4HQMQ.7BCCCzzg8tuxBSuk7lrmY/cNHlO.WF6', NULL, '2025-02-20 07:54:24', '2025-02-20 07:54:24', 'admin');
...
ALTER TABLE `borrowings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_borrowings_members` (`member_id`),
  ADD KEY `fk_borrowings_copies` (`book_copy_id`);
...
ALTER TABLE `copies`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unq_copies_book_id` (`book_id`);
...
ALTER TABLE `fines`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_fines_borrowings` (`borrowing_id`),
  ADD KEY `fk_fines_members` (`member_id`);
...
ALTER TABLE `members`
  ...
  ADD KEY `fk_members_types` (`membership_type_id`);
...
ALTER TABLE `reservations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_reservations_members` (`member_id`),
...
ALTER TABLE `resources`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_resources_categories` (`category_id`),
  ADD KEY `fk_resources_authors` (`author_id`);
...
ALTER TABLE `waitings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_waitings_books` (`book_id`),
  ADD KEY `fk_waitings_members` (`member_id`);
...
ALTER TABLE `books`
  ...
  ADD CONSTRAINT `fk_books_categories` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_books_publishers` FOREIGN KEY (`publisher_id`) REFERENCES `publishers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `borrowings`
--
ALTER TABLE `borrowings`
  ADD CONSTRAINT `fk_borrowings_copies` FOREIGN KEY (`book_copy_id`) REFERENCES `copies` (`book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_borrowings_members` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `copies`
--
ALTER TABLE `copies`
  ADD CONSTRAINT `fk_copies_books` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `fines`
--
ALTER TABLE `fines`
  ADD CONSTRAINT `fk_fines_borrowings` FOREIGN KEY (`borrowing_id`) REFERENCES `borrowings` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_fines_members` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `members`
  ADD CONSTRAINT `fk_members_types` FOREIGN KEY (`membership_type_id`) REFERENCES `types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_members_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `fk_payments_members` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `reservations`
--
ALTER TABLE `reservations`
  ADD CONSTRAINT `fk_reservations_books` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_reservations_members` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `resources`
--
ALTER TABLE `resources`
  ADD CONSTRAINT `fk_resources_authors` FOREIGN KEY (`author_id`) REFERENCES `authors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_resources_categories` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `waitings`
--
ALTER TABLE `waitings`
  ADD CONSTRAINT `fk_waitings_books` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_waitings_members` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
